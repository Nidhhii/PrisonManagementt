...
urlpatterns = [
    ...
    url(r'post_accept/',views.post_accept,name="post_accept"),
    url(r'post_reject/',views.post_reject,name="post_reject"),
    url(r'post_check3/',views.post_check3,name="post_check3"),
    url(r'postaddguard/',views.postaddguard,name="postaddguard"),
